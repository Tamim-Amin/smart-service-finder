            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if($userRole === 'customer')
                        ...
                        <x-nav-link :href="route('customer.search')" :active="request()->routeIs('customer.search')">
                            {{ __('Find Services') }}
                        </x-nav-link>
                    ...
                    @elseif($userRole === 'provider')
                        ...
                        <x-nav-link :href="route('provider.profile.edit')"
                            :active="request()->routeIs('provider.profile.edit')">
                            {{ __('My Profile') }}
                        </x-nav-link>
                        <x-nav-link :href="route('provider.earnings')" :active="request()->routeIs('provider.earnings')">
                            {{ __('Earnings') }}
                        </x-nav-link>
        ...
        <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                ...
                @if($userRole === 'customer')
                    ...
                    <x-responsive-nav-link :href="route('customer.search')" :active="request()->routeIs('customer.search')">
                        {{ __('Find Services') }}
                    </x-responsive-nav-link>
                ...
                @elseif($userRole === 'provider')
                    ...
                    <x-responsive-nav-link :href="route('provider.earnings')"
                        :active="request()->routeIs('provider.earnings')">
                        {{ __('Earnings') }}
                    </x-responsive-nav-link>
                @elseif($userRole === 'admin')
                    ...
                    <x-responsive-nav-link :href="route('admin.providers')" :active="request()->routeIs('admin.providers')">
                        {{ __('Providers') }}
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('admin.categories')"
