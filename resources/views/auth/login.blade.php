...
<body class="bg-gradient-to-br from-indigo-100 via-purple-50 to-pink-100 min-h-screen">
    <div class="min-h-screen flex items-center justify-center px-4 py-10 sm:py-12">
        <div
            ...
            <div
                class="hidden md:flex flex-col justify-center items-center bg-gradient-to-br from-indigo-600 to-purple-700 p-8 lg:p-12 text-white">
                <div class="text-center max-w-sm">
                    ...
                    <div class="space-y-4 text-left text-sm lg:text-base">
                        <div class="flex items-center space-x-3">
                            <svg class="w-5 h-5 lg:w-6 lg:h-6 flex-shrink-0" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M5 13l4 4L19 7" />
                            </svg>
